...
<!-- Common Gateway Interface scripts written in PHP language-->

<!-- The post method sends the form data in its own seperate data stream
- most secure form of data transfer-->
<br>
